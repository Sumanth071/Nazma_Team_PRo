...
export const AdminLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070b14] flex items-center justify-center p-4 sm:p-6 font-sans relative">
      ...
      <div className="absolute top-5 right-5 z-30">
        <button
          ...
          className="p-2.5 rounded-xl bg-slate-900/90 border border-slate-800 text-slate-300 hover:text-rose-400 shadow-sm transition-all cursor-pointer"
        >
      ...
      <div className="w-full max-w-4xl bg-[#0d1322] rounded-3xl shadow-2xl overflow-hidden border border-rose-900/30 grid grid-cols-1 md:grid-cols-12 min-h-[580px] relative z-10">
        
        {/* Left Side: Administrator Command Center HUD (5 cols) */}
        <div className="md:col-span-5 bg-gradient-to-br from-[#0a0f1d] via-[#11182c] to-[#150e1f] p-8 sm:p-10 text-white flex flex-col justify-between border-b md:border-b-0 md:border-r border-rose-900/20 relative overflow-hidden">
          
          <div className="space-y-6">
            {/* Header Badge */}
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-rose-500 to-rose-700 flex items-center justify-center text-white font-black shadow-lg shadow-rose-600/30 border border-rose-400/30">
              ...
              <div>
                ...
                <div className="text-[11px] text-rose-300/80 font-mono tracking-wider uppercase">
                  Governance & Security Terminal
                </div>
              </div>
            </div>

            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/30 text-[11px] font-mono font-semibold text-rose-300">
          ...
          <div className="pt-6 border-t border-rose-900/30 text-[11px] font-mono text-slate-400 flex items-center justify-between">
        ...
        <div className="md:col-span-7 p-8 sm:p-10 flex flex-col justify-center bg-[#0d1322] text-white">
          <div className="max-w-md w-full mx-auto space-y-6">
            <div className="space-y-1">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-rose-950/50 border border-rose-800 text-[11px] font-bold text-rose-400 uppercase tracking-wider">
                Restricted Access
              </div>
              <h2 className="text-2xl font-bold text-white tracking-tight">Administrator Sign In</h2>
            ...
            <div className="p-4 rounded-2xl bg-rose-950/30 border border-rose-900/50 space-y-2.5">
              ...
              <button
                ...
                className="w-full p-3 rounded-xl bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-500 hover:to-rose-600 text-white font-bold text-xs flex items-center justify-between shadow-lg shadow-rose-600/30 transition-all cursor-pointer group"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-700 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-rose-500 focus:ring-2 focus:ring-rose-500/20 transition-all"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 px-4 rounded-xl bg-rose-600 hover:bg-rose-500 text-white text-xs font-bold shadow-md shadow-rose-600/30 transition-all disabled:opacity-50 cursor-pointer"
              >
