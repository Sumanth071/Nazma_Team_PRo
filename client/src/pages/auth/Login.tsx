  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] dark:bg-[#070f26] flex items-center justify-center p-4 sm:p-6 font-sans transition-colors relative">
      ...
      <div className="w-full max-w-5xl bg-white dark:bg-[#0d1838] rounded-3xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800 grid grid-cols-1 lg:grid-cols-12 min-h-[620px] transition-colors">
        ...
        <div className="lg:col-span-7 relative p-8 sm:p-10 text-white flex flex-col justify-between overflow-hidden border-b lg:border-b-0 lg:border-r border-slate-800/80 min-h-[460px] lg:min-h-[620px]">
          ...
          {HOSPITAL_SCENES.map((scene, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#040817] via-[#07112e]/70 to-[#04091a]/85" />
          ...
          <div className="relative z-20 flex items-center justify-between gap-3">
            ...
            <div className="hidden sm:inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-900/80 backdrop-blur-md border border-cyan-500/40 text-[11px] font-semibold text-cyan-300 shadow-[0_0_12px_rgba(6,182,212,0.25)]">
          ...
          <div className="relative z-20 my-auto py-6 space-y-3.5 max-w-lg">
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-lg bg-cyan-500/20 border border-cyan-400/40 text-cyan-300 text-xs font-semibold uppercase tracking-wider backdrop-blur-md shadow-xs">
              <Radio className="w-3.5 h-3.5 text-cyan-400 animate-pulse" />
              <span>{currentScene.tag}</span>
            </div>

            <div className="space-y-1.5">
              <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight leading-snug drop-shadow-md">
                {currentScene.title}
              </h1>
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <div className="p-3 rounded-2xl bg-white/10 dark:bg-slate-950/70 border border-white/20 backdrop-blur-md">
          ...
          <div className="relative z-20 pt-3 border-t border-white/15 flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              {HOSPITAL_SCENES.map((scene, index) => (
                <button
                  ...
                  className={`group px-3 py-1 rounded-xl text-xs font-semibold transition-all flex items-center gap-1.5 cursor-pointer ${
            ...
            <div className="flex items-center gap-1.5 text-[11px] text-cyan-300/90 font-mono font-medium">
        ...
        <div className="lg:col-span-5 p-8 sm:p-10 flex flex-col justify-center bg-white dark:bg-[#0d1838] transition-colors">
          <div className="max-w-sm w-full mx-auto space-y-5">
            <div className="space-y-1">
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Staff Sign In</h2>
            ...
            <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 space-y-2.5">
              ...
              <div className="grid grid-cols-2 gap-2.5">
                ...
                <button
                  ...
                  className="p-3 rounded-xl bg-white dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-500 hover:bg-blue-50/50 dark:hover:bg-blue-950/40 text-center transition-all shadow-2xs group cursor-pointer"
                >
                  <div className="flex items-center justify-center gap-1.5 text-xs font-bold text-slate-800 dark:text-slate-200 group-hover:text-blue-600 dark:group-hover:text-blue-400">
                ...
                <button
                  ...
                  className="p-3 rounded-xl bg-white dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700 hover:border-amber-500 dark:hover:border-amber-500 hover:bg-amber-50/50 dark:hover:bg-amber-950/40 text-center transition-all shadow-2xs group cursor-pointer"
                >
                  <div className="flex items-center justify-center gap-1.5 text-xs font-bold text-slate-800 dark:text-slate-200 group-hover:text-amber-600 dark:group-hover:text-amber-400">
